...
pipeline
{
 ...
 stages
 {
     stage('Code checkout')
     {
         steps
         {
             script
             {
                 checkout([$class: 'GitSCM', branches: [[name: '*/development']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/xxxx/maven-web-application.git']]])
 ...
 post
 {
     ...
     success
     {
        ...
        Build Team
        ''', compressLog: true, replyTo: 'example@gmail.com', 
        subject: '$PROJECT_NAME - $BUILD_NUMBER - $BUILD_STATUS', to: 'example@gmail.com'
     }
     failure
     {
